...
The 95% confidence limits for the deep temperature residuals (where pressure :math:`\geq` 2000dbar) are ±0.00087°C for SBE35RT-T1, ±0.00099°C for SBE35RT-T2 and ±0.00087°C for T1-T2.
...
The 95% confidence limits for the deep salinity residuals (where pressure :math:`\geq` 2000dbar) are ±0.00158 mPSU for salinity-C1SAL.
