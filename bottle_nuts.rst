...
* The cruise started with new pump tubes and they were changed once, before station 033.
...
The deep check sample that is normally run was discontinued due to issues with cadmium column efficiency on A20.  It is thought the mercuric chloride may have been contributing to the loss of column efficiency.
...
.. table::
  ...
  ========= ============= ======= =============
  \-        (µmol/kg)     \-      (µmol/kg)
  |NO3|     15.86          0.02    15.86
  |PO4|     1.17          0.005     1.177
  Sil       34.7          0.12     34.72
  |NO2|     0.04          0.005    0.04
  ========= ============= ======= =============
...
Analytical Problems
-------------------
There were issues with the cadmium column efficiency on A20. The exact issue was never clearly identified but it appears to have been a combination of buffer that was not stable which affected the efficiency and life span of the cadmium reduction columns.
The values of the reference material and the were used to in addition to the periodic column efficiency checks to monitor data quality. Adjustments based on the values obtained for the references material were made as necessary. 
